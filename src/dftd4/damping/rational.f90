...
pure subroutine get_2b_damp(self, param, r2, rdamp, d6, d8)
   ...
   real(wp) :: r6, r8, rdamp2, rdamp6, rdamp8
   ...
   rdamp8 = rdamp6 * rdamp2

   d6 = param%s6 / (r6 + rdamp6)
   d8 = param%s8 / (r8 + rdamp8)
...
pure subroutine get_2b_derivs(self, param, r2, rdamp, d6, d8, d6dr, d8dr)
   ...
   real(wp) :: r4, r6, r8, rdamp2, rdamp6, rdamp8
...
pure subroutine get_3b_damp(self, param, r, r2ij, r2ik, r2jk, &
   ...
   real(wp) :: r3ij, r3ik, r3jk, fij, fik, fjk

   r3ij = r2ij * sqrt(r2ij)
   r3ik = r2ik * sqrt(r2ik)
   r3jk = r2jk * sqrt(r2jk)

   fij = r3ij / (r3ij + rdampij**3)
   fik = r3ik / (r3ik + rdampik**3)
   fjk = r3jk / (r3jk + rdampjk**3)
...
pure subroutine get_3b_derivs(self, param, r, r2ij, r2ik, r2jk, &
   ...
   real(wp) :: r3ij, r3ik, r3jk, fij, fik, fjk, pre
