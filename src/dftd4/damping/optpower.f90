...
pure subroutine get_2b_damp(self, param, r2, rdamp, d6, d8)
   ...
   real(wp) :: r6, r8, rdamp2, rdamp6, rdamp8, rb, ab, t6, t8
   ...
   t6 = rb / (rb * r6 + ab * rdamp6)
   t8 = rb / (rb * r8 + ab * rdamp8)
...
pure subroutine get_2b_derivs(self, param, r2, rdamp, d6, d8, d6dr, d8dr)
   ...
   real(wp) :: r4, r6, r8, rdamp2, rdamp6, rdamp8, rb, ab, t6, t8, pre
   ...
   d6dr = param%s6 * t6**2 * (-6.0_wp * r4 + pre * rdamp6)
   d8dr = param%s8 * t8**2 * (-8.0_wp * r6 + pre * rdamp8)
