...
pure subroutine get_2b_damp(self, param, r2, rdamp, d6, d8)
   ...
   real(wp) :: ratior, r6, r8, t6, t8, inv6, inv8, alp6, alp8
   
   alp6 = param%alp
   alp8 = param%alp + 2.0_wp

   ratior = rdamp / sqrt(r2)
   r6 = r2*r2*r2
   r8 = r6*r2
...
pure subroutine get_3b_damp(self, param, r, r2ij, r2ik, r2jk, &
   ...
   real(wp) :: rij, rik, rjk, t3ij, t3ik, t3jk, inv3ij, inv3ik, inv3jk

   rij = sqrt(r2ij)
   rik = sqrt(r2ik)
   rjk = sqrt(r2jk)

   t3ij = (param%rs9 * rdampij / rij)**param%alp
   t3ik = (param%rs9 * rdampik / rik)**param%alp
   t3jk = (param%rs9 * rdampjk / rjk)**param%alp
...
pure subroutine get_3b_derivs(self, param, r, r2ij, r2ik, r2jk, &
   ...
   real(wp) :: rij, rik, rjk, t3ij, t3ik, t3jk, inv3ij, inv3ik, inv3jk, pre
...
pure subroutine get_3b_damp_avg(self, param, r, r2ij, r2ik, r2jk, &
   ...
   d9 = param%s9 / (1.0_wp + 6.0_wp * (rdamp / r)**(param%alp / 3.0_wp))
...
pure subroutine get_3b_derivs_avg(self, param, r, r2ij, r2ik, r2jk, &
   ...
   real(wp) :: dftmp, t9, inv9

   t9 = (rdamp / r)**(param%alp / 3.0_wp)
