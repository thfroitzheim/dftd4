...
pure subroutine get_2b_damp(self, param, r2, rdamp, d6, d8)
   ...
   real(wp) :: r1, r6, r8, x6, x8, t6, t8, inv6, inv8, alp6, alp8
   ...
   x6 = r1 / (param%rs6 * rdamp) + param%bet * rdamp
   x8 = r1 / (param%rs8 * rdamp) + param%bet * rdamp
...
pure subroutine get_2b_derivs(self, param, r2, rdamp, d6, d8, d6dr, d8dr)
   ...
   real(wp) :: r1, r6, r8, t6, t8, x6, x8, dt6, dt8, inv6, inv8, alp6, alp8
   ...
   dt6 = r1 / (x6 * param%rs6 * rdamp)
   dt8 = r1 / (x8 * param%rs8 * rdamp)
