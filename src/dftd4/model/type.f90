...
subroutine get_dispersion2_energy(self, mol, cache, param, trans, cutoff, energy)
   ...
   do iat = 1, mol%nat
      ...
      do jat = 1, iat
         ...
         rdamp = self%get_2b_rdamp(izp, jzp, param%a1, param%a2)
...
subroutine get_dispersion3_energy(self, mol, cache, param, trans, cutoff, energy)
   ...
   do iat = 1, mol%nat
      ...
      do jat = 1, iat
         jzp = mol%id(jat)
         rdampij = self%get_3b_rdamp(izp, jzp, param%a1, param%a2)
         do jtr = 1, size(trans, 2)
            ...
            do kat = 1, jat
               ...
               rdampik = self%get_3b_rdamp(izp, kzp, param%a1, param%a2)
               rdampjk = self%get_3b_rdamp(jzp, kzp, param%a1, param%a2)
