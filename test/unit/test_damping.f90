...
subroutine test_damping_2b_gen(error, mol, d4, damp, param, ref6, ref8)
   ...
   do iat = 1, mol%nat
      ...
      do jat = 1, mol%nat
         ...
         ! Get damping radius
         rdamp = d4%get_2b_rdamp(izp, jzp, param%a1, param%a2)
...
subroutine test_damping_3b_gen(error, mol, d4, damp, param, ref9)
   ...
   do jat = 1, mol%nat
      ...
      rdampij = d4%get_3b_rdamp(izp, jzp, param%a1, param%a2)
      ...
      do kat = 1, mol%nat
         ...
         rdampik = d4%get_3b_rdamp(izp, kzp, param%a1, param%a2)
         rdampjk = d4%get_3b_rdamp(jzp, kzp, param%a1, param%a2)
